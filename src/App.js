...
import CountryOptions from './component/CountriesOptions'
...
class App extends Component {
  ...
  renderResult = count => {
    ...
    return count === 0 ? (
      <div className="empty-card">
        <p className="msg">No Countries Visited Yet </p>
      </div>
    ) : (
      <ul className="visited-countries-list">
        {countriesList.map(eachCountry => (
          <Country
            ...
            onChangeCountryState={this.onChangeCountryState}
            key={eachCountry.id}
          />
        ))}
      </ul>
  ...
  render() {
    ...
    console.log(visitedCountriesList.length)
    ...
    return (
      <div className="bg-container">
        <div className="detailed-container">
          ...
          {this.renderResult(visitedCountriesList.length)}
        </div>
      </div>
    )
  }
